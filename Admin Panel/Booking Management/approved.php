<?php
// bookings/approved.php - Approved/Active Bookings
$breadcrumb = 'Booking Management > Approved';
$pageTitle = 'Approved Bookings';
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>NeighborNest · Approved Bookings</title>
    ...
    <style>
        /* Include all styles from pending.php - compact version */
        :root {
            --nn-primary: #1E3A5F;
...
<body>
        ...
        <div class="page-content">
            ...
            <div class="page-header fade-up">
                <div class="d-flex flex-wrap justify-content-between align-items-center">
                    <div>
                        ...
                        <p>View all approved and currently active bookings.</p>
                    </div>
                    <span class="badge bg-success" style="font-size:0.8rem;padding:0.4rem 1rem;">45 Active</span>
                </div>
            </div>
                    ...
                    <div class="stat-card">
                        <div class="d-flex justify-content-between align-items-start">
                            <div>
                                ...
                                <div class="stat-label">Starting Today</div>
                            </div>
                ...
                <div class="col-6 col-md-3 fade-up delay-3">
                    <div class="stat-card">
                        <div class="d-flex justify-content-between align-items-start">
                            ...
                            <div class="stat-icon"><i class="fas fa-hourglass-end" style="color:var(--nn-amber);"></i></div>
                        </div>
                    </div>
                </div>
                <div class="col-6 col-md-3 fade-up delay-4">
                    <div class="stat-card">
                        <div class="d-flex justify-content-between align-items-start">
                            ...
                            <div class="stat-icon"><i class="fas fa-chart-line" style="color:var(--nn-primary-light);"></i></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="fade-up delay-2">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-end">
                                    ...
                                    <button class="btn-sm-nn danger">Cancel</button>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td><span class="fw-medium">#B1017</span></td>
                                <td>Vikram Reddy</td>
                                <td>Park Place</td>
                                <td>Jul 1, 2024</td>
                                <td>Aug 1, 2024</td>
                            ...
                            <tr>
                                <td><span class="fw-medium">#B1016</span></td>
                                <td>Ravi Kumar</td>
                                <td>Sunrise PG</td>
                                <td>Jul 3, 2024</td>
                                <td>Aug 3, 2024</td>
                ...
                <div class="d-flex flex-wrap justify-content-between align-items-center mt-3">
                    <span class="small text-secondary-custom">Showing 1-4 of 45 active bookings</span>
    ...
    <script>
        (function() {
            ...
            console.log('NeighborNest · Active Bookings loaded.');
        })();
    </script>
